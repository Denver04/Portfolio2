    ...
    <div className='body'>
      <div className='body1' data-aos="zoom-in">
        <div className='body-left'>
            ...
            <p>Currently, I'm persuing B.E from Computer Engineering branch from Army Institute of Technology, Pune and right now I'm in fourth year.</p>
            <div className='icons'>
              ...
              <div className='tooltip'>
                <a href="https://www.hackerrank.com/abhisekkumarsin1"><i class="fa-brands fa-hackerrank"></i></a>
              </div>
              <div className='tooltip'>
